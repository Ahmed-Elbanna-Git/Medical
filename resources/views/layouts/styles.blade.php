 ...
 <link rel="apple-touch-icon" href="{!!url('dashboard')!!}/app-assets/images/ico/apple-icon-120.png">
    ...
    <link rel="stylesheet" type="text/css" href="{!!url('dashboard')!!}/app-assets/vendors/css/tables/datatable/dataTables.bootstrap4.min.css">
    ...
    <link rel="stylesheet" type="text/css" href="{!!url('dashboard')!!}/app-assets/css/colors.min.css">
