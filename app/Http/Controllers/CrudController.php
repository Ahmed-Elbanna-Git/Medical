...
class CrudController extends Controller
{
    ...
    public function runValidation()
    {
        ...
        if (request()->ajax()) {
            ...
            $validator = validator()->make($this->request->all(),$validationRequest->rules($id),$this->rulesMessages);
           ...
           if ($validator->fails()) {
                ...
                return responseJson(0,$messages);
            }else{
    ...
    { 
       ...
       $data->update(['status' => 1]);
        ...
        toastr()->success(trans('main.updated_successfully'));
        return redirect()->route($this->basicRoute . '.index');
    }
